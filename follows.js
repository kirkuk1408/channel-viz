(function ( $ ){
	...
	*/
	...
	var defaultKey		= '4vNTgw5ELvpNIrHVOzrYoEf7m3oJxdUhJtrmZspwqc0xZvHp', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1532605269], // Comma separated array of Xively Feed ID numbers
		applicationName	= '', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 10800, // Default interval for data to be displayed (in seconds)
		dataColor		= '0A1022', // CSS HEX value of color to represent data (omit leading #)
